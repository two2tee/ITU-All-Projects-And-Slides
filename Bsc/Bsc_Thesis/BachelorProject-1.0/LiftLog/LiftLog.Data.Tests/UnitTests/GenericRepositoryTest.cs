...
namespace LiftLog.Data.Tests.UnitTests
{
    public class GenericRepositoryTest
    {
        ...
        [Fact(DisplayName = "CreateAsync throws exception if context is disposed")]
        ...
        [Fact(DisplayName = "FindAsync returns null if entity not found.")]
        public async Task Test_FindAsync_ReturnNull_IfEntityNotFound()
        {
            // Arrange 
            using (var repo = CreateDummyRepository())
            {
                // Act 
                var result = await repo.FindAsync(4234);
