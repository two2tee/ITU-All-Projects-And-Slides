...
class PlanningTester(BaseTester):
    ...
    def run_specific_test(self, test_name):
        with torch.no_grad():
            ...
            trial_actions, trial_rewards, trial_elites, seed = test_func(args=args)
            plt.close('all')
            return test_name, trial_actions, trial_rewards, trial_elites, seed
    ...
    def _run_multithread_new_test_session(self):
        with ProcessPoolExecutor(max_workers=multiprocessing.cpu_count()) as executor:
            ...
            test_results = {}
            for test_name, trial_actions, trial_rewards, trial_elites, seed in thread_results:
    ...
    def _run_planning_test(self, start_track, args):
        ...
        return trial_actions, trial_rewards, trial_elites, seed
