""" Iterative trainer train MDRNN iteratively based on standard or corner rollouts
    Flow:
...
class AgentWrapper:
    ...
    def search(self, state):
        ...
        if self.config['planning']['planning_agent'] == "MCTS":
            ...
            action, _, _ = self.agent.search(self.simulated_environment, self.latent, self.hidden)
        return action
