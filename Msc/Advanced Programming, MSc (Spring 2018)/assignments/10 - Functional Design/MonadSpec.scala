...
// Monad associative and identity laws represented as property tests 
object  MonadSpec extends Properties("Monad[F[_]] laws..") {
  ...
  // Test properties for option monad over integers, list monad over integers, and list monad over strings 
  property ("of optionMonad") = monad[Int,Option] (optionMonad)
  property ("listMonad") = monad[Int,List] (listMonad) 
  property ("listMonad") = monad[String,List] (listMonad)

  // TODO: How do we generalize composed monads over type A using implicit parameters and higher kinded types ???
