...
public class ParallelHistogram3 {
    ...
    private final Histogram3 histogram;

    public ParallelHistogram3(int span) {
        histogram = new Histogram3(span);
    }

    public Histogram3 getHistogram() {
        return histogram;
    }
    ...
    public static void main (String[] args) {
        ...
        final int span = 25;
        ParallelHistogram3 histogramProgram = new ParallelHistogram3(span);
