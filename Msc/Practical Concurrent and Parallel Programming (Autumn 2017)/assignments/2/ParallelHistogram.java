...
public class ParallelHistogram {
    ...
    private final Histogram2 histogram;

    public ParallelHistogram(int span) {
        histogram = new Histogram2(span);
    }

    public Histogram2 getHistogram() {
        return histogram; 
    }
    ...
    public static void main (String[] args) {
        ...
        final int span = 25;
        ParallelHistogram histogramProgram = new ParallelHistogram(span);
